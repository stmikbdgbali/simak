...
<script>
	...
	export default {
		name: "PAGE",
		created() {
			this.cicilan_id = this.$route.params.cicilan_id;
			this.breadcrumbs = [
				{
					text: "HOME",
					disabled: false,
				...
				},
				{
					...
					disabled: true,
					href: "/keuangan/cicilanpengembangan",
				},
				{
					text: "DETAIL",
					disabled: true,
		...
		methods: {
			initialize: async function() {
				...
				await this.$ajax
					.get("/keuangan/cicilan-pengembangan/" + this.cicilan_id, {
						headers: {
							Authorization: this.$store.getters["auth/Token"],
						},
					})
					.then(({ data }) => {
						this.datatable = data.daftar_cicilan;
