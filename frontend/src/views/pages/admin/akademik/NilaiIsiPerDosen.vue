        ...
        <ModuleHeader>
            ...
            <template v-slot:desc>
                <v-alert                                        
                    ...
                    type="info"
                    >
                    Halaman untuk melakukan pengisian nilai berdasarkan kelas yang diampu oleh Dosen berdasarkan kelas yang telah dibentuk pada pembagian kelas.
                </v-alert>
            </template>
        </ModuleHeader>
                    ...
                    <v-data-table
                        ...
                        <template v-slot:item.actions="{ item }">
                            <v-btn
                                small
                                icon
                                @click.stop="$router.push('/akademik/nilai/matakuliah/isiperdosen/'+item.id)"
