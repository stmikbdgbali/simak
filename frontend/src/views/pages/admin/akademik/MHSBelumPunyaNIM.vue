									...
									<v-card color="grey lighten-4">
										...
										<v-card-text>
											<v-alert
												...
												type="info"
											>
												Mahasiswa Baru yang belum melakukan pembayaran SPP bulan
												September {{ $tahun_pendaftaran }} belum bisa daftar
												ulang otomatis
											</v-alert>
											<v-row>
												<v-col cols="12">
	...
	export default {
		...
		methods: {
			...
			initialize: async function() {
				...
				await this.$ajax
					.post(
						"/akademik/dulang/mhsbelumpunyanim",
						{
			...
			save() {
				if (this.$refs.frmdata.validate()) {
					...
					this.$ajax
						.post(
							"/akademik/dulang/mhsbelumpunyanim/store",
							{
